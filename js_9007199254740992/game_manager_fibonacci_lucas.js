...
// Tests whether two tiles sum to a Fibonacci number
...
// Tests whether two tiles sum to a Lucas number
GameManager.prototype.testLuc = function(value) {
  var fib = [2,1]
  ...
  traversals.x.forEach(function (x) {
    traversals.y.forEach(function (y) {
      ...
      if (tile) {
        ...
        if (next && (self.testFib(next.value, tile.value) || self.testLuc(next.value, tile.value)) && !next.mergedFrom) {
